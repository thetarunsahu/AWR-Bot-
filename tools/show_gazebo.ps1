...
& docker exec -d $Container bash -lc 'export DISPLAY=host.docker.internal:0.0; export QT_X11_NO_MITSHM=1; export LIBGL_ALWAYS_SOFTWARE=1; gz sim -g > /tmp/gz_gui.log 2>&1'
